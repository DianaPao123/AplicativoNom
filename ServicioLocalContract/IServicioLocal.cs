...
namespace ServicioLocalContract
{
	...
	public interface IServicioLocal
	{
        ...
        [OperationContract]
        ComprobantePdf GetComprobantePdfx(string uudi);
        ...
        [OperationContract]
        bool SaveSubcontratacionNomina(SubContratacion datos);
        ...
        [OperationContract]
        bool EliminarSubcontratacion(int idcliente);
        ...
        string CancelarFactura33(string rfcEmisor, string folioFiscal, string expresion, string rfcReceptor);
        ...
        [OperationContract]
        List<SubContratacion> ListaSubContratacion(int cliente);
		[OperationContract]
