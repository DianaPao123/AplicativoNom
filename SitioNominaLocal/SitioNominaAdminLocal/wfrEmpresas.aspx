<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="wfrEmpresas.aspx.cs" Inherits="SitioNominaAdmin.wfrEmpresas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td><asp:TextBox runat="server" ID="txtLeyendaPie" Width="400px"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            <td />
            <td>Debes de modificar los 3 siguientes datos en conjunto.</td>
        </tr>
