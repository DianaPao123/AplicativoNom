...
{
    public partial class wrfTimbrado : System.Web.UI.Page
    {
        ...
        protected void gvFacturas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName.Equals("Cancelar"))
            {
                try
                {
                    ...
                    {
                        var venta = cliente.GetFactura(id);
                        cliente.CancelarFactura(venta.RfcEmisor, venta.Guid);
                        this.FillView();
                    }
                }
        ...
        protected void ddlEmpresas_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            using (cliente as IDisposable)
            {
                ...
                List<vventas> ventas = cliente.ListaFacturas(fechaInicial, fechaFinal, int.Parse(this.ddlEmpresas.SelectedValue),
                    int.Parse(this.ddlClientes.SelectedValue), "A", iniciales).OrderByDescending(p => p.folio).ToList();
